...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");let l={email:"",message:""};function r(){if(null!==localStorage.getItem("feedback-form-state")){let e=JSON.parse(localStorage.getItem("feedback-form-state"));a.email.value=e.email,a.message.value=e.message,l={email:e.email,message:e.email}}}function s(e){if(""!==a.email.value&&""!==a.message.value)return e.preventDefault(),e.target.reset(),localStorage.removeItem("feedback-form-state"),console.log(l),l={email:"",message:""};alert("Bсе поля должны быть заполнены!")}r(),a.addEventListener("input",(0,e.default)(e=>{e.target===a.email?l.email=e.target.value:e.target===a.message&&(l.message=e.target.value),localStorage.setItem("feedback-form-state",JSON.stringify(l))},500)),a.addEventListener("submit",s);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.7faa2d38.js.map